...
qq.FineUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader">' +
            ...
            (!this._options.button ? '<div class="input-append"><input class="fileInput" data-bind="value: $root.file" type="text" /><button class="qq-upload-button btn"><div>{uploadButtonText}</div></button></div>' : '') +
        ...
        fileTemplate: '<li style="display: none;">' +
            ...
            '<span class="qq-upload-file" file"></span>' +
